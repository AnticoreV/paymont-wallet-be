...
public class WalletController implements WalletsApi {
    ...
    @Override
    public ResponseEntity<WalletResponse> createWallet(@Valid CreateWalletRequest request) {
        WalletResponse response = walletService.createWallet(request.getCurrency());
    ...
    @Override
    public ResponseEntity<TransactionResponse> topUp(UUID walletId, @Valid TopUpRequest request) {
        return ResponseEntity.ok(walletService.topUp(walletId, request));
    }

    @Override
    public ResponseEntity<TransactionResponse> withdraw(UUID walletId, @Valid WithdrawRequest request) {
